...
$sql = "SELECT PersonalInfo, EmergContact, DocInfo,
CurrentMed, PresMedHist, ChronicDisease, FamDisease, PastMedHist, HeartDiseaseRisk FROM shares WHERE Receiver = '$id' AND Sender = $name[user_id]";
